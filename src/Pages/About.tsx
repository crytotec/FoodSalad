  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      ...
      <div className="w-[90%] md:w-[80%] mx-auto mt-16 mb-20 flex flex-col gap-6 items-center">
        ...
        <div className="w-full md:w-[90%] mx-auto mt-10 flex flex-col gap-6 items-center">
          <h2 className="text-2xl md:text-3xl font-semibold text-center text-red-600">
            Meet the Team
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center">
            {Chef.map((item, index) => (
              <div
                key={index}
                className="relative w-[150px] h-[250px] md:w-[250px] md:h-[300px] group rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer"
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-red-600 bg-opacity-60 flex w-full flex-col justify-center items-center text-center text-white transition-opacity duration-500 p-4 ${
